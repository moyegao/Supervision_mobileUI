...
// }
	...
	dialog.prototype = {
		...
		init : function(data) {
			...
			this.DOM.find(".personal-nameDiv").click(function() {
				self.selectStaff(event.target);
			});
			this.DOM.find(".rightBox").click(function(){
		...
		tabSwitch : function(target) {
			...
			if (select_type == 1) {// 选项卡***人员
				this.DOM.find(".personal-nameDiv,.department-div").show().css('width', 'calc(100% - 35px)');
